...
save(networkData14_normalized_normfactors,networkData14_normalized,file = "networkData14 norm and factors")

# step 3 - select var top 50 & 90% of the counts above 10
# top 50 variance 
networkData14_normalized$variance = apply(networkData14_normalized, 1, var)
nrow(networkData14_normalized) - sum(networkData14_normalized$variance >= quantile(networkData14_normalized$variance,c(.50)))
...
#================================================================================================
## good genes --- ok
gsg_all = goodSamplesGenes(networkData_normalized, verbose = 3);
gsg_all$allOK
...
table(moduleColors14_cl == module_name)
table(moduleColors14_cl)
#=================================================================================================
#                              6. plotting heatmap                                            ###
#=================================================================================================
...
mp14 = modulePreservation(multiExpr14,multiColor14,referenceNetworks=1,verbose=3,
                          networkType="unsigned", nPermutations=50, 
                          maxGoldModuleSize=50, maxModuleSize=400, 
...
# data.frame(color = modColors14[plotMods], label = labs14)
#===========================================================================================
#                                10. KEGG enrichment                                      ##
#===========================================================================================
setwd("/Users/liulihe95/Desktop/HeatStress0708");getwd()
library(biomaRt);library(clusterProfiler);library(ggplot2);library(dplyr);library(magrittr)
require("biomaRt");require("gage")
