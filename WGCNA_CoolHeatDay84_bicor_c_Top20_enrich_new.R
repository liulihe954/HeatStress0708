...
#
pdf("KEGG_Enrichment_in_modules_bicor_c_day84_new.pdf")
...
dev.off()
save(KEGG_results_b, file = "KEGG_results_bicor_c_top20_day84.RData")
...
#
pdf("GO_Enrichment_in_modules_bicor_c_day84_new.pdf")
for (i in c(1:(length(nonpres_modulenames_b)))){
...
dev.off()
save(GO_results_b, file = "GO_results_bicro_c_top20_day84_new.RData")
