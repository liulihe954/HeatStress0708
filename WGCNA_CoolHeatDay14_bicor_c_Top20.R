...
sizeGrWindow(9,5)
cex1 = 0.9
pdf(file = "soft_bicor_c_threshold_picking_day14.pdf", width = 12, height = 9)
par(mfrow = c(1,2))
...
#==========================================================================================
# cor
pdf("dendrogram_bicor_c_day14.pdf",     height=6,width=16)
par(mfrow=c(1,2))
...
sizeGrWindow(8,16)
pdf("dendrogram_bicor_c_cl_nomg_day14.pdf",height=8,width=16)
...
sizeGrWindow(8,16)
pdf("Clustering_of_module_eigengenes_bicor_cl_day14.pdf",height=8,width=16)
...
#                              6. plotting heatmap                                            ###
#=================================================================================================
pdf("Network_heatmap_plot_bicor_c_all_genes_cl_day14.pdf",height=8,width=16)
for (i in c(6:12)){
...
#===============================================================================================
pdf("Gene_dendrogram_cross_condition_bicor_c_day14.pdf",height=8,width=16)
...
#
pdf("medianRank_Zsummary_vs_module_size_bicor_c_day14.pdf",height = 8, width = 16)
...
pdf("all_module_preservation_statistics_nested_bicor_day14.pdf",height = 8, width = 16)
par(mfrow = c(4,5))
