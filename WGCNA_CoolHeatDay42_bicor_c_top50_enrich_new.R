...
########################################################################################################################
networkData14_4pre = DataPre_C(networkData42, cousin = 0.4, 6, 6, 0.5)
...
#                                           keyword = "KEGG_Enrichment_Day42_bicor_c_top50_z5_0911")
#===========================================================================================
...
GO_Enrichment_Results = Go_Enrich_Plot(total.genes,
                                       ...
                                       TestingGroupAssignment = moduleColors14_b_cl,
                                       TestingSubsetNames = nonpres_modulenames_b,
                                       keyword = "GO_Enrichment_Day42_bicor_c_top50_z005_0920")
