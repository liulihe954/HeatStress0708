...
# dim(datExpr14_ht);dim(datExpr14_cl)
# Peaerson Cor
#adjacency14_cl = adjacency(datExpr14_cl,power=6,type="unsigned",corFnc = "cor");
adjacency14_cl = abs(cor(datExpr14_cl));
...
adjacency14_ht = abs(cor(datExpr14_ht));
