...
plot(sft_b_cl$fitIndices[,1], -sign(sft_b_cl$fitIndices[,3])*sft_b_cl$fitIndices[,2],
     xlab="Soft Threshold bicor (power) 42_cl",ylab="Scale Free Topology Model Fit bicor, unsigned R^2 42_cl",type="n",
     main = paste("Scale independence bicor 42_cl"));
...
plot(sft_b_cl$fitIndices[,1], sft_b_cl$fitIndices[,5],
     xlab="Soft Threshold bicor (power) 42_cl",ylab="Mean Connectivity bicor 42_cl",type="n",
     main = paste("Mean connectivity bicor 42_cl"))
text(sft_b_cl$fitIndices[,1], sft_b_cl$fitIndices[,5], labels=powers, cex=cex1,col="red")
abline(h=MeanK_b,col="red")
dev.off()
#save
save(sft_b_cl,softPower_b,MeanK_b,file = "SoftThres_bicor_c_day42.RData")
...
#==========================================================================================
# cor
pdf("dendrogram_bicor_c_day42.pdf",     height=6,width=16)
par(mfrow=c(1,2))
plot(geneTree14_b_cl,xlab="",sub="",main="Gene clustering on TOM-based dissimilarity bicor (42_cl)",labels=FALSE,hang=0.04);
plot(geneTree14_b_ht,xlab="",sub="",main="Gene clustering on TOM-based dissimilarity bicor (42_ht)",labels=FALSE,hang=0.04);
dev.off()
...
sizeGrWindow(8,16)
pdf("dendrogram_bicor_cl_nomg_day42.pdf",height=8,width=16)
plotDendroAndColors(geneTree14_b_cl, dynamicColors14_b_cl, "Dynamic Tree Cut bicor 42_cl nomg",
                    dendroLabels = FALSE, hang = 0.03,
                    addGuide = TRUE, guideHang = 0.05,
                    main = "Gene dendrogram and module colors bicor 42_cl nomg")
dev.off()
...
sizeGrWindow(8,16)
pdf("Clustering_of_module_eigengenes_bicor_c_cl_day42.pdf",height=8,width=16)
plot(METree14_b_cl, main = "Clustering of module eigengenes bicor 42_cl",
     xlab = "", sub = "")
...
#                              6. plotting heatmap                                            ###
#=================================================================================================
pdf("Network_heatmap_plot_bicor_c_all_genes_cl_top20_day42.pdf",height=8,width=16)
for (i in c(6:12)){
...
#===============================================================================================
pdf("Gene_dendrogram_cross_condition_bicor_c_top20_day42.pdf",height=8,width=16)
plotDendroAndColors(geneTree14_b_cl, moduleLabels14_b_cl, "Modules", dendroLabels=F, hang=0.03, addGuide=TRUE,
                    guideHang=0.05, main="Gene dendrogram and module colors bicor (42_cl)")
plotDendroAndColors(geneTree14_b_ht, moduleLabels14_b_cl, "Modules", dendroLabels=F,hang=0.03, addGuide=TRUE,
                    guideHang=0.05, main="Gene dendrogram and module colors bicor (42_ht)")
dev.off()
...
write.csv(Results_b_mp14_1,"module_size_and_preservation_statistics_bicor_c_day42.csv")
################ output - shortest - only p summmary  ######################
...
write.csv(Obs.PreservationStats14_b,"Obs.PreservationStats_bicor_c_top20_day42.csv")
write.csv(Z.PreservationStats14_b,"Z.PreservationStats_bicor_c_top20_day42.csv")
...
#
pdf("medianRank_Zsummary_vs_module_size_bicor_c_top20_day42.pdf",height = 8, width = 16)
...
pdf("all_module_preservation_statistics_nested_bicor_c_top20_day42.pdf",height = 8, width = 16)
par(mfrow = c(4,5))
