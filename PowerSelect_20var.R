...
DataPre_C = function(networkData, cousin = 0.4, n1 = 6, n2 = 6, perct = .50, method = "leek"){
  #function prepare
  ...
  networkData_filter = remove_filter(networkData,0.4)$networkData_filter
  ...
  networkData_correction = Correct_pca(networkData_log2_50var,method)
  ...
  save(networkData_final,
       ...
       networkData14_normalized_normfactors,
       networkData14_normalized,
       file = paste(networkData,"prepare with corrections.RData"))
}
DataPre = function(networkData, cousin = 0.4, n1 = 6, n2 = 6, perct = .50){
  #function prepare
  remove_filter = function(networkData,thres){
    ID_meanexpr1 = data.frame(names = rownames(networkData), mean = apply(networkData, MARGIN = 1,mean));
    ID_meanexpr2 = cbind(ID_meanexpr1,percent = ID_meanexpr1$mean/sum(ID_meanexpr1$mean))
  ...
  #names(networkData_final) = names(networkData_log2_50var)
  return(list(Corrected_log2_PC = networkData_final))
  save(networkData_filnal,
       networkData14_normalized_normfactors,
       networkData14_normalized,
       file = paste(networkData,"prepare no correction.RData"))
}
...
###                                     2. day14 cor                                       ######
#================================================================================================
networkData14_prec = DataPre(networkData14,cousin = 0.4, n1 = 6, n2 = 6, perct = .20)

networkData14_final = networkData14_prec$
